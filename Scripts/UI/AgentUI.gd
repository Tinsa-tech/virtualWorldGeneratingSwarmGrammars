...
func lock():
	...
	noc_obj.lock()
	see_obj.lock()
	energy_move_mode_obj.lock()
	energy_move_value_obj.lock()
	energy_successor_mode_obj.lock()
	energy_successor_value_obj.lock()
	energy_successor_value_2_obj.lock()
	energy_persist_mode_obj.lock()
	energy_persist_value_obj.lock()
	energy_zero_successors_obj.lock()
	energy_zero_value_obj.lock()
	a_max_obj.lock()
	v_max_obj.lock()
	v_norm_obj.lock()
	view_distance_obj.lock()
	beta_obj.lock()
	separation_distance_obj.lock()
	constraints_obj.lock()
	influences_obj.lock()
	super.lock()
...
func unlock():
	...
	noc_obj.unlock()
	see_obj.unlock()
	energy_move_mode_obj.unlock()
	energy_move_value_obj.unlock()
	energy_successor_mode_obj.unlock()
	energy_successor_value_obj.unlock()
	energy_successor_value_2_obj.unlock()
	energy_persist_mode_obj.unlock()
	energy_persist_value_obj.unlock()
	energy_zero_successors_obj.unlock()
	energy_zero_value_obj.unlock()
	a_max_obj.unlock()
	v_max_obj.unlock()
	v_norm_obj.unlock()
	view_distance_obj.unlock()
	beta_obj.unlock()
	separation_distance_obj.unlock()
	constraints_obj.unlock()
